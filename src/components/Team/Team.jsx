                ...
                <div className="team-grid grid grid-cols-1 md:grid-cols-2 gap-8 px-8">
                    <article className="team-member bg-white rounded-lg overflow-hidden shadow-md flex flex-col md:flex-row animate-item">
                        <div className="member-photo flex-none w-full md:w-40">
                            <img src="https://images.unsplash.com/photo-1560250097-0b93528c311a?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" alt="Directeur général" loading="lazy" className="w-full h-48 md:h-full object-cover" />
                        </div>
                        <div className="member-info p-6 flex-1">
                            <h3 className="text-xl font-bold highlight-hover">M. Amon</h3>
                    ...
                    <article className="team-member bg-white rounded-lg overflow-hidden shadow-md flex flex-col md:flex-row animate-item">
                        <div className="member-photo flex-none w-full md:w-40">
                            <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" alt="Directrice technique" loading="lazy" className="w-full h-48 md:h-full object-cover" />
                        </div>
                        <div className="member-info p-6 flex-1">
                            <h3 className="text-xl font-bold highlight-hover">Mme Ouattara</h3>
                            <p className="position text-secondary font-semibold mb-2 pulse-color">Directrice technique</p>
